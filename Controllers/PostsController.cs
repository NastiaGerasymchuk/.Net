...
namespace LabLastGer8.Controllers
{
    public class PostsController : Controller
    {
        ...
        public PostsController(LecturerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string sortOrder)
        {
            ...
            {
                case "postName_desc":
                    posts = posts.OrderByDescending(s => s.PostName);
                    break;
                default:
                    posts = posts.OrderBy(s => s.PostName);
                    break;
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,PostName")] Post post)
        {
